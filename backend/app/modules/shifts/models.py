...
class Shift(Base):
    ...
    fuel_consumed_liters: Mapped[Decimal | None] = mapped_column(Numeric(8, 3), nullable=True)
    motohours_accumulated: Mapped[Decimal | None] = mapped_column(Numeric(8, 3), nullable=True)
