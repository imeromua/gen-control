...
class GeneratorRepository:
    ...
    async def create_settings(self, settings: GeneratorSettings) -> GeneratorSettings:
    ...
    async def create_event_log(self, event: EventLog) -> EventLog:
        self.db.add(event)
        await self.db.commit()
